...
void LoopwhileStmt::accept(ASTVisitor& visitor) { visitor.visit(this); }

void SayStmt::accept(ASTVisitor& visitor) { visitor.visit(this); }
void TraceStmt::accept(ASTVisitor& visitor) { visitor.visit(this); }
